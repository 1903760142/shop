...
<script>
    $(function(){
            ...
            $(document).on('click',"#btnLogin",function () {
                ...
                $.post(
                    "{{url('LoginAdd')}}",
                    {login_name:login_name,login_pwd:login_pwd,_token:_token,verifycode:verifycode},
                    function (res) {
                        if( res==1 || that.val()=="登录成功")
                        {
